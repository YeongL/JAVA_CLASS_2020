...
public class NoteCellPhoneExample {
	...
	public static void main(String[] args) {
		...
		NoteCellPhone NoteCellPhone = new NoteCellPhone("자바폰", "검정", 10);
        ...
        NoteCellPhone.bell();
        NoteCellPhone.sendVoice("여보세요?");
        NoteCellPhone.receiveVoice("안녕하세요. 홍길동 입니다");
        NoteCellPhone.sendVoice("네, 반갑습니다");
