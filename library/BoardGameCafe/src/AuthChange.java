...
public class AuthChange extends JFrame implements ItemListener,ActionListener{
	...
	public AuthChange() {
		...
		passwordField.registerKeyboardAction(this, "º¯°æ", KeyStroke.getKeyStroke(KeyEvent.VK_ENTER,0),JComponent.WHEN_FOCUSED);
		btnNewButton.setActionCommand("º¯°æ");
		btnNewButton_1.setActionCommand("Ãë¼Ò");
	...
	public void actionPerformed(ActionEvent e) {
        ...
        case "º¯°æ":
        	...
        	if(res.getEauth().equals("»çÀå") || res.getEauth().equals("¸Å´ÏÀú"))
        	{
        		new EmpDBUpdate(empname,empauth);
        		JOptionPane.showMessageDialog(null, "¼º°øÀûÀ¸·Î º¯°æÇß½À´Ï´Ù.","¼º°ø!",JOptionPane.INFORMATION_MESSAGE);
        		dispose();
        	}
        	else
        	{
        		JOptionPane.showMessageDialog(null, "±ÇÇÑÀÌ ºÎÁ·ÇÕ´Ï´Ù. ´Ù½Ã ÀÔ·ÂÇØÁÖ¼¼¿ä.","¿À·ù!",JOptionPane.ERROR_MESSAGE);
        	}
